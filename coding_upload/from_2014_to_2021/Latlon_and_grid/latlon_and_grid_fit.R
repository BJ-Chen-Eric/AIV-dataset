...
# Mon May 19 16:23:51 2025 ------------------------------


# fit 2013-2021 genotype data into 100*100 km2 grid
...
Location_more_than_3_fixed_2014_to_2021 <- Location_more_than_3_fixed[(Location_more_than_3_fixed$C_year >= 2014)&(Location_more_than_3_fixed$C_year <= 2021), ]
...
# csv_data <- Location_more_than_3_fixed_2004_to_2013
# lon_col = "Longitude"
# lat_col = "Latitude"
# geom_col = 'Id'
...
test1 <- count_point_in_polygon(shpfile = Global_Fish_100km, 
                                csv_data = Location_more_than_3_fixed_2014_to_2021, 
                                lon_col = "Longitude", 
                                lat_col = "Latitude", 
                                geom_col = 'Id')
...
H5HPAI_2014_to_2021_in_grid <- merge(x = ID_continent, y = test1, by = 'Id')
H5HPAI_2014_to_2021_in_grid <- H5HPAI_2014_to_2021_in_grid %>% as.data.frame()
H5HPAI_2014_to_2021_in_grid <- H5HPAI_2014_to_2021_in_grid[, -4]

write.csv(H5HPAI_2014_to_2021_in_grid, file = '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/from_2014_to_2021/Latlon_and_grid/data/H5HPAI_2014_to_2021_in_grid.csv', row.names = F)
...
#---------------------------------------------------------------------
# fit 2014-2021 genotype data into 100*100 km2 grid, count type num
Location_more_than_3_fixed <- read.csv('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/Latlon_and_grid/data/Location_more_than_3_fixed.csv')
...
H5HPAI_genotypenum_2014_to_2021_in_grid <- merge(x = ID_continent, y = ID_typenum, by = 'Id')


write.csv(H5HPAI_genotypenum_2014_to_2021_in_grid, file = '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/from_2014_to_2021/Latlon_and_grid/data/H5HPAI_genotypenum_2014_to_2021_in_grid.csv', row.names = F)
