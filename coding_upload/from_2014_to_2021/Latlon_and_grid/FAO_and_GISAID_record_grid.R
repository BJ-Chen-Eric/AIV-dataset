...
Location_more_than_3_fixed_before_2021 <- Location_more_than_3_fixed[Location_more_than_3_fixed$C_year <= 2021, ]
...
GISAID_with_uncomplete <- count_point_in_polygon(shpfile = Global_Fish_100km, 
                                csv_data = Location_more_than_3_fixed_before_2021, 
                                lon_col = "Longitude", 
                                lat_col = "Latitude", 
                                geom_col = 'Id')
...
Location_more_than_3_fixed_before_2021_completed <- Location_more_than_3_fixed_before_2021[Location_more_than_3_fixed_before_2021$Complete > 0, ]


GISAID_with_complete <- count_point_in_polygon(shpfile = Global_Fish_100km, 
                                                 csv_data = Location_more_than_3_fixed_before_2021_completed, 
                                                 lon_col = "Longitude", 
                                                 lat_col = "Latitude", 
                                                 geom_col = 'Id')
...
fao_before_2021 <- NICD_correct_position_to_2023[NICD_correct_position_to_2023$OB_year <= 2021, ] %>% as.data.frame()


FAO_grid <- count_point_in_polygon(shpfile = Global_Fish_100km, 
                                               csv_data = fao_before_2021, 
                                               lon_col = "Longitude", 
                                               lat_col = "Latitude", 
                                               geom_col = 'Id')
...
colnames(FAO_grid2)[2] <- 'FAO_AIV_before_2021'
...
colnames(GISAID_with_complete2)[2] <- 'GISAID_complete_before_2021'
...
colnames(GISAID_with_uncomplete2)[2] <- 'GISAID_all_before_2021'
...
complete_grid_data4[complete_grid_data4$FAO_AIV_before_2021 %in% 1 | complete_grid_data4$GISAID_all_before_2021 %in% 1, 'Group_2'] <- 1

complete_grid_data4$Group_3 <- complete_grid_data4$GISAID_complete_before_2021



# ----------------------------------------------------------------
# Mon May 19 16:46:31 2025 ------------------------------
# after finish LISA, go through below
...
LISA_AS <- read_csv('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/from_2014_to_2021/LISA/result/LISA_AS.csv')
LISA_EU <- read_csv('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/from_2014_to_2021/LISA/result/LISA_EU.csv')
...
write.csv(complete_grid_data4, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/from_2014_to_2021/Latlon_and_grid/FAO_and_GISAID_record_grid_data/complete_grid_data_20250519.csv', row.names = F)
