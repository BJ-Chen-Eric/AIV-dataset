...
# ---------------------------------------------------------------------
# 開始分析
gb.map.nb <- read.csv("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/LISA/data/neighbor.csv")
# NOnb <- gb.map.nb[gb.map.nb$neigh1 == 0,]
# OwO <- NOnb$id
alltype <- read.csv("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/Latlon_and_grid/data/H5HPAI_genotypenum_2000_to_2013_in_grid.csv")
...
write.csv(LISA_EU, file = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/LISA/result/LISA_EU.csv", row.names = FALSE)
...
write.csv(LISA_AS, file = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/LISA/result/LISA_AS.csv", row.names = FALSE)
