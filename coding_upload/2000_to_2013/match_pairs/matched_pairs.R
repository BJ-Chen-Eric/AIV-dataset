...
setwd("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/")

complete_grid_data <- read.csv("母資料/complete_grid_data_20250528.csv")
...
# write.csv(clog_EU_all_grid, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_EU_all_grid.csv', row.names = F)
write.csv(clog_EU_group2, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_EU_group2.csv', row.names = F)
write.csv(clog_EU_group3, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_EU_group3.csv', row.names = F)


# write.csv(clog_AS_all_grid, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_AS_all_grid.csv', row.names = F)
write.csv(clog_AS_group2, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_AS_group2.csv', row.names = F)
write.csv(clog_AS_group3, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/clog_AS_group3.csv', row.names = F)
