...
complete_grid_data <- fread('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/Latlon_and_grid/FAO_and_GISAID_record_grid_data/complete_grid_data_20250528.csv') %>% as.data.frame()
bird_YN_asia <- fread('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/鳥種母資料/bird_YN_asia.csv') %>% as.data.frame()
bird_YN_europe <- fread('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/鳥種母資料/bird_YN_europe.csv') %>% as.data.frame()


bird_num_asia <- fread('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/鳥種母資料/bird_num_asia.csv')
bird_num_europe <- fread('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/鳥種母資料/bird_num_europe.csv')
...
# other ENV factors
H5_HPAI_farm <- read.csv("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/整理好的/FAO_2000_to_2013_H5HPAI_outbreak_poultryfarm.csv")
...
livestock <- read.csv("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/variable_arrange_for_second_stage/整理好的/livestock.csv")
...
results <- match_pair_result(file_OwO = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/sig_bird_decide/AUC_df/3_subset_4_model_4_index/")
...
# for output route
sim_log_csv <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/sim_log_csv/'
sim_log_table <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/sim_log_table/'

mul_log_csv <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/mul_log_csv/'
mul_log_table <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/mul_log_table/'
...
for (i in seq_along(list_OwO)) {
  ...
  EEE <- merge(x = CCC, y = livestock[,c(1,5,6,7)], by = "Id", all.x = TRUE)
  GGG <- EEE[,-1]
  ...
  if (length(model_1$coefficients) == 2) {
    ...
    final_output_df[i, 'Include_bird_num'] <- include_bird_num[[1]]
    final_output_df[i, 'p_value_thre'] <- include_pvalue[[1]]
    final_output_df[i, 'Youden_Index'] <- youden_index
    final_output_df[i, 'Alpha'] <- ES_result[['alpha']]
    final_output_df[i, 'Lambda'] <- ES_result[['lambda']]
...
write.csv(final_output_df, file = '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/Over_all_table/Over_all_table_20250528.csv', row.names = F)
...
mul_log_results <- match_pair_result(file_OwO = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/mul_log_csv/")
...
write.csv(over_all_tt, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/Over_all_table/PN_VAR.csv')
...
# for output route
sim_log_csv <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/sim_log_csv/'
sim_log_table <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/sim_log_table/'

mul_log_csv <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/mul_log_csv/'
mul_log_table <- '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/mul_log_table/'
...
Over_all_table_20250522 <- read.csv('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/PRS_separate/Over_all_table/Over_all_table_20250522.csv')
...
for (j in seq_along(model_list)) {
  ...
  refer_table <- Over_all_table_20250522[grep(pattern = model_name, x = Over_all_table_20250522$Model_Index), ]
...
write.csv(final_output_df, file = '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/Over_all_table/Over_all_table_20250522.csv', row.names = F)




# Coefficient P/N table in mul. reg.--------------------------------------------
mul_log_results <- match_pair_result(file_OwO = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/mul_log_csv/")
...
write.csv(over_all_tt, '/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/logistic_reg_with_PSR/logistic_regression/elastic_net_non_sig_retain/4_index_compete/Over_all_table/PN_VAR.csv')
