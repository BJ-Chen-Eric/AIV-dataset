...
results <- match_pair_result(file_OwO = "/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/match_pairs/result/")
results_OwO <- results
...
# write out csv
 for (k in seq_along(model_subset_index_list)) {
   ...
   route_df <- paste('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/sig_bird_decide/AUC_df/3_subset_4_model_4_index/', df_name, '.csv', sep = '')
...
for (k in seq_along(model_subset_index_list)) {
  ...
  save_route <- paste('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/2000_to_2013/logistic_reg_with_PSR/sig_bird_decide/AUC_plot/3_subset_4_model_4_index/', df_name, '.png', sep = '')
