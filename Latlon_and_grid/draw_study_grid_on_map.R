...
complete_grid_data <- read.csv('/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/Latlon_and_grid/FAO_and_GISAID_record_grid_data/complete_grid_data_20250505.csv')
...
ggsave("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/Latlon_and_grid/study_grid_visulization/2004_to_2013.png", plot = sp_plot1, width = 15, height = 9, dpi = 300, bg = "white")

library(svglite)
ggsave("/media/dyclab/新增磁碟區/Jeffery/HH_analysis/before_2013/Latlon_and_grid/study_grid_visulization/2004_to_2013.svg", plot = sp_plot1, width = 15, height = 9, units = "in")
